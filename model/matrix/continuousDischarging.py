...
class GetArrays:
    ...
    def constArray(self, props, temperatureList):
        ...
        # Fluid - 1. robni pogoj
        constants[halfArray] = (props.voidFrac*rhoGas[halfArray]*cGas[halfArray]*props.flowVelocity*props.dt*props.dz + 2*props.kf*props.dt)*props.Tambient + 2*props.voidFrac*rhoGas[halfArray]*cGas[halfArray]*props.dz**2*temperatureList[halfArray]
