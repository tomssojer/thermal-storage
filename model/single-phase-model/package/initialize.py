def prepareCharging(zNodes):
    ...
    coefficients = [[0 for zTemp in range(zNodes)] for zTemp in range(zNodes)]
    # Matrix of constants
    constants = [0 for zTemp in range(zNodes)]
...
def temperatures(zNodes, rNodes, temperature):
    ...
    initTemperatures = [[temperature for zTemp in range(zNodes)] for rTemp in range(rNodes)]
